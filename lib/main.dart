...
class _HomepageState extends State<Homepage> {
  ...
  List<Model> dataList = [
    Model(
        question: "Question 1",
        answer:
            'asdasdasdasdasdasdasd  asdasdasdas dasd asdasd asdas dasd asd asd asda sdas d',
        isExpand: false,
        hight: 0),
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              // Check condition icon: true arrow up, false arrow down
                                Icon(item.isExpand!? Icons.keyboard_arrow_up: Icons.keyboard_arrow_down),
                              ],
                            ),
                          ),
                        ),
                        ...
                        Container(
                          ...
                          height: item.isExpand! ? null : 0, //ถ้าต้องการ Fix ความสูงใส่ item.hight แทน item.isExpand! ? null : 0
